...
import com.trendinganalysis.conetrading.R;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP / getResources().getDisplayMetrics().density);
...
//            tabTitleView.setBackground(getResources().getDrawable(R.drawable.tab_color_selector));


//            tabTitleView.setTextSize(20 / getResources().getDisplayMetrics().density);
        }
    }
