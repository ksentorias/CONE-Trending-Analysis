 ...
 */
public class LocalMarketTabActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab_activity_local_market, container, false);
...
//         to use for it
        ...
        setData(datahandler.getReportLMProducts());
