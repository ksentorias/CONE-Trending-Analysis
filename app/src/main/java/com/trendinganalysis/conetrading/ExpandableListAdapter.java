...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    // child data in format of header headerTitle, child headerTitle
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.date_header, null);
        }

        TextView titleNi = (TextView) convertView.findViewById(R.id.headerTitle);
        titleNi.setText(headerTitle);
