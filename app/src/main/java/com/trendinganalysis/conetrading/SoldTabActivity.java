 ...
 */
public class SoldTabActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab_activity_sold, container, false);
...
//         to use for it
        ...
        //get data from SOLD List
        setData(datahandler.getReportSDProducts());
